...
import Link from 'next/link';
  ...
  console.log("Login Wala Response response",errors)
  ...
  return (
    ...
    <div className="w-84 bg-white p-6 rounded-lg shadow-lg">
      ...
      <form onSubmit={SubmitHandler}>
        ...
        <div className='mb-4'>
           I Don't have an Account : <Link href="/register" className="text-blue-500 hover:text-blue-700 underline font-bold"> Register </Link>
        </div>
